...
// picacoin includes.
#include <..\src\script\picacoinconsensus.h>
...
int main()
{
    std::cout << "picacoinconsensus version: " << picacoinconsensus_version() << std::endl;
    ...
    auto op0Result = picacoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, picacoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
