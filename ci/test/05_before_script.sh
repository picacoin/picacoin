...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Picacoin
else
  DOCKER_EXEC echo \> \$HOME/.picacoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/picacoin/picacoin/pull/18288#discussion_r433189350 for
  # details.
