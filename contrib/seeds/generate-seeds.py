...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef PICACOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define PICACOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the picacoin network\n')
    ...
    g.write('#endif // PICACOIN_CHAINPARAMSSEEDS_H\n')
