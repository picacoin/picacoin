...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the picacoin repository."
  exit 1
fi
...
# See https://github.com/picacoin/picacoin/issues/16064
...
echo 'When compiling picacoind, run `./configure` in the following way:'
echo
