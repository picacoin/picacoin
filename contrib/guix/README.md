# Bootstrappable Picacoin Core Builds

This directory contains the files necessary to perform bootstrappable Picacoin
Core builds.
...
From the top of a clean Picacoin Core repository:
...
To use dongcarl's substitute server for Picacoin Core builds after having
