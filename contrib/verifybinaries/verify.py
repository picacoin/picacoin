...
picacoincore.org and picacoin.org and compares them.
...
WORKINGDIR = "/tmp/picacoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://picacoincore.org"
HOST2 = "https://picacoin.org"
VERSIONPREFIX = "picacoin-core-"
...
def main(args):
    ...
    if not success:
        print("picacoin.org failed to provide signature file, "
              "but picacoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("picacoin.org and picacoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Picacoin Core binary release "
