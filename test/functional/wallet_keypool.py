...
class KeyPoolTest(PicacoinTestFramework):
    ...
    def run_test(self):
        ...
        # Using a fee rate (10 pio / byte) well above the minimum relay rate
        # creating a 5,000 pio transaction with change should not be possible
        ...
        # creating a 10,000 pio transaction without change, with a manual input, should still be possible
        ...
        # creating a 10,000 pio transaction without change should still be possible
        ...
        # creating a 10,000 pio transaction with a manual change address should be possible
