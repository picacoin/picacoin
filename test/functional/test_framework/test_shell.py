...
class TestShell:
    """Wrapper Class for PicacoinTestFramework.

    The TestShell class extends the PicacoinTestFramework
    ...
    class __TestShell(PicacoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by PicacoinTestFramework child class.
            self.num_nodes = 1
