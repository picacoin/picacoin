...
This file is modified from python-picacoinlib.
"""
...
def bn2vch(v):
    """Convert number to picacoin-specific little endian format."""
...
def FindAndDelete(script, sig):
    """Consensus critical, see FindAndDelete() in Picaro codebase"""
    r = b''
