...
By default, picacoind will dump mempool on shutdown and
...
class MempoolPersistTest(PicacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent picacoind from writing mempool.dat to disk. Verify that `savemempool` fails")
