...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the PicacoinTestFramework
    pass


class ExampleTest(PicacoinTestFramework):
    # Each functional test is a subclass of the PicacoinTestFramework class.
    ...
    def custom_method(self):
        ...
        PicacoinTestFramework class so other tests can use it."""
