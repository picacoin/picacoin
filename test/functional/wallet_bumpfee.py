...
class BumpFeeTest(PicacoinTestFramework):
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by Picacoin to serialize ECDSA signatures means that signatures can have a
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 PIC / 1000 vbytes = 0.00002820 PIC
