...
class VersionBitsWarningTest(PicacoinTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because picacoind will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
