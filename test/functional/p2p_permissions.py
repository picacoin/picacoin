...
class P2PPermissionsTests(PicacoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].picacoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].picacoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
