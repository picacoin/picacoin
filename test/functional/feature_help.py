...
"""Verify that starting picacoin with -h works as expected."""

from test_framework.test_framework import PicacoinTestFramework
from test_framework.util import assert_equal

class HelpTest(PicacoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start picacoin with -h for help text")
        ...
        self.log.info("Start picacoin with -version for version information")
        ...
        self.log.info("Start picacoind with -fakearg to make sure it does not start")
