...
class RawTransactionsTest(PicacoinTestFramework):
    ...
    def test_invalid_change_address(self):
        ...
        assert_raises_rpc_error(-5, "Change address must be a valid picacoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
    ...
    def test_option_feerate(self):
        ...
        # With no arguments passed, expect fee of 141 picaros.
    ...
    def test_option_subtract_fee_from_outputs(self):
        ...
        # Test subtract fee from outputs with feeRate (PIC/kvB)
        ...
        # picaros more, than outputs 2 and 3.
    ...
    def test_transaction_too_large(self):
        ...
        # Make 1500 0.1 PIC outputs. The amount that we target for funding is in
