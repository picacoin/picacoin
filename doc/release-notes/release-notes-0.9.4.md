Picacoin Core version 0.9.4 is now available from:

  https://picacoin.org/bin/0.9.4/
...
this update is incompatible with the Picacoin system and could lead to consensus
forks.

Picacoin Core released binaries from https://picacoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~picacoin/+archive/ubuntu/picacoin
- A third-party or self-compiled Picacoin Core

upgrade to Picacoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
