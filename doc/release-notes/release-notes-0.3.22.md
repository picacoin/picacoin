Download URL: https://sourceforge.net/projects/picacoin/files/Picacoin/picacoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 PIC fee schedule (users still pay 0.01 PIC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #picacoin00 - #picacoin99
