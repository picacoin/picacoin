Picacoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/picacoin/files/Picacoin/picacoin-0.5.4/
...
http://gitorious.org/picacoin/picacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Picacoin-Qt notifications under Growl 1.3.
Increase required age of Picacoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPicacoin properly when installing Picacoin-Qt over it. (Windows)
