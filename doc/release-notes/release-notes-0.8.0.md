Picacoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/picacoin/files/Picacoin/picacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Picacoin
...
New/changed settings (command-line or picacoin.conf file)
--------------------------------------------------------
