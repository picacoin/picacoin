Picacoin Core version *0.14.3* is now available from:

  <https://picacoin.org/bin/picacoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/picacoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
