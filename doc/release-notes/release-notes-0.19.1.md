...
Picacoin Core version 0.19.1 is now available from:

  <https://picacoincore.org/bin/picacoin-core-0.19.1/>
...
From Picacoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Picacoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Picacoin Core does not yet change appearance when
...
- #17488 fix "picacoind already running" warnings on macOS (fanquake)
