Picacoin Core version 0.9.2.1 is now available from:

  https://picacoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PIC to 0.01 PIC
...
- Fix "Start picacoin on system login"
