Picacoin Core version 0.13.2 is now available from:

  <https://picacoin.org/bin/picacoin-core-0.13.2/>
...
- #8908 `4a974b2` Update picacoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow picacoin-tx to create v2 transactions (btcdrak)
