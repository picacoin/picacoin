Picacoin Core version 0.16.1 is now available from:

  <https://picacoincore.org/bin/picacoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting picacoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure picacoind processes are cleaned up when tests end (sdaftuar)
