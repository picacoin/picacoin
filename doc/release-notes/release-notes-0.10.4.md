Picacoin Core version 0.10.4 is now available from:

  <https://picacoin.org/bin/picacoin-core-0.10.4/>
...
- #6953 `43c2789` Split picacoin-tx into its own package
- #6953 `dfe0d4d` Include picacoin-tx binary on Debian/Ubuntu
