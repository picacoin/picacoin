...
This document provides guidelines for internationalization of the Picacoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `picacoin_en.ts` remains unchanged.
