...
#ifndef PICACOIN_WALLET_SCRIPTPUBKEYMAN_H
#define PICACOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Picacoin Core wallet was originally a collection of unrelated private
...
#endif // PICACOIN_WALLET_SCRIPTPUBKEYMAN_H
