...
#ifndef PICACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define PICACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // PICACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
