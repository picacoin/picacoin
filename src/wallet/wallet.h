...
//! Discourage users to set fees higher than this amount (in picaro) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in picaro)
...
public:
    ...
    /** Absolute maximum transaction fee (in picaro) used by default for the wallet */
