...
#ifndef PICACOIN_WALLET_WALLETUTIL_H
#define PICACOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! picacoin from opening the wallet, thinking it was newly created, and
...
#endif // PICACOIN_WALLET_WALLETUTIL_H
