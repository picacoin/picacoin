...
#ifndef PICACOIN_WALLET_ISMINE_H
#define PICACOIN_WALLET_ISMINE_H
 ...
 * https://github.com/picacoin/picacoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // PICACOIN_WALLET_ISMINE_H
