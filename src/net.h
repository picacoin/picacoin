...
#ifndef PICACOIN_NET_H
#define PICACOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/picacoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Picacoin’s Peer-to-Peer Network")
