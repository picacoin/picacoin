    ...
    platformStyle(_platformStyle)
{
    ...
    // normal picacoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying picacoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &PicacoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
