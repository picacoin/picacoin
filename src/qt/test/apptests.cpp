...
//! Entry point for PicacoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &PicacoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for PicacoinGUI tests.
void AppTests::guiTests(PicacoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &PicacoinGUI::consoleShown, this, &AppTests::consoleTests);
