...
#ifndef PICACOIN_QT_RECEIVECOINSDIALOG_H
#define PICACOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of picacoins */
...
#endif // PICACOIN_QT_RECEIVECOINSDIALOG_H
