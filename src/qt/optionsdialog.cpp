    ...
    mapper(nullptr)
{
    ...
    ui->picacoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->picacoinAtStartup);
    ...
    ui->picacoinAtStartup->setToolTip(ui->picacoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->picacoinAtStartup->setText(ui->picacoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openPicacoinConfButton->setToolTip(ui->openPicacoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new PicacoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->picacoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPicacoinConfButton_clicked()
{
