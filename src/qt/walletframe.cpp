...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, PicacoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &PicacoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &PicacoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &PicacoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &PicacoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &PicacoinGUI::updateWalletStatus);
    connect(gui, &PicacoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
