...
#ifndef PICACOIN_QT_GUIUTIL_H
#define PICACOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Picacoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "picacoin:" URI into recipient object, return true on successful parsing
