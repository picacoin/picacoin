 ...
 */
#ifndef PICACOIN_UTIL_SYSTEM_H
#define PICACOIN_UTIL_SYSTEM_H
...
extern const char * const PICACOIN_CONF_FILENAME;
extern const char * const PICACOIN_SETTINGS_FILENAME;
