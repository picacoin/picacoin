...
public:
    CMainParams() {
        ...
        consensus.SegwitHeight = 5000; // 0000000000000000001c8018d9cb3b742ef25114f27563e3fc4a1902167f9893
        consensus.MinBIP9WarningHeight = 7016; // segwit activation height + miner confirmation window
