...
#ifndef PICACOIN_INTERFACES_INIT_H
#define PICACOIN_INTERFACES_INIT_H
...
//! (picacoin-gui, picacoin-node, picacoin-wallet, picacoind, picacoin-qt) and each
...
#endif // PICACOIN_INTERFACES_INIT_H
