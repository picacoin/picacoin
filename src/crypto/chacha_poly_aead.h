...
#ifndef PICACOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define PICACOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@picacoin.
 *
 ...
 *
 * The chacha20-poly1305@picacoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@picacoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@picacoin are relatively fast in
...
#endif // PICACOIN_CRYPTO_CHACHA_POLY_AEAD_H
