...
#ifndef PICACOIN_TEST_SCRIPTNUM10_H
#define PICACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Picacoin Core 0.10.0, for cross-comparison.
 */
public:
