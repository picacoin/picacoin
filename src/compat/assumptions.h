...
#ifndef PICACOIN_COMPAT_ASSUMPTIONS_H
#define PICACOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Picacoin cannot be compiled without assertions."
#endif
...
#endif // PICACOIN_COMPAT_ASSUMPTIONS_H
