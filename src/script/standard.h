...
#ifndef PICACOIN_SCRIPT_STANDARD_H
#define PICACOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a picacoin address
 */
...
/**
 * Generate a Picacoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // PICACOIN_SCRIPT_STANDARD_H
