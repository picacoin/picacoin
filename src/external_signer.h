// Copyright (c) 2018-2021 The Picacoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef PICACOIN_EXTERNAL_SIGNER_H
#define PICACOIN_EXTERNAL_SIGNER_H
...
#endif // PICACOIN_EXTERNAL_SIGNER_H
